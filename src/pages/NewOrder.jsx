...
function NewOrder() {
  ...
  const updateZone = (zoneId) => {
    ...
    setOrder((current) => ({ ...current, zoneId, zone: zone?.area || "", deliveryCharge: zone?.charge || current.deliveryCharge }))
  }
...
function createEmptyOrder() { return { customerName: "", phone: "", address: "", zoneId: "", zone: "", deliveryCharge: 0, products: [createProductRow()], discount: 0, paymentMethod: "COD", transactionId: "", paymentStatus: "Unpaid", notes: "" } }
